    ...
    _createClass(InertRoot, [
      {
        ...
        value: function destructor() {
          ...
          try {
            for (
              var _iterator = this._managedNodes[Symbol.iterator](), _step;
      ...
      },
      {
        ...
        value: function _adoptInertRoot(node) {
          ...
          try {
            for (
              var _iterator2 = inertSubroot.managedNodes[Symbol.iterator](),
                _step2;
      ...
      },
      {
        ...
        value: function _onMutation(records, self) {
          ...
          try {
            for (
              var _iterator3 = records[Symbol.iterator](), _step3;
              ...
              if (record.type === "childList") {
                ...
                try {
                  for (
                    var _iterator4 = Array.from(record.addedNodes)[
                        Symbol.iterator
                      ](),
                      _step4;
                ...
                try {
                  for (
                    var _iterator5 = Array.from(record.removedNodes)[
                        Symbol.iterator
                      ](),
                      _step5;
                ...
                if (record.attributeName === "tabindex") {
                  ...
                  try {
                    for (
                      var _iterator6 = this._managedNodes[Symbol.iterator](),
                        _step6;
    ...
    _createClass(InertManager, [
      ...
      },
      {
        ...
        value: function _onDocumentLoaded() {
          ...
          try {
            for (
              var _iterator7 = inertElements[Symbol.iterator](), _step7;
      ...
      },
      {
        ...
        value: function _watchForInert(records, self) {
          ...
          try {
            for (
              var _iterator8 = records[Symbol.iterator](), _step8;
              ...
              switch (record.type) {
                case "childList":
                  ...
                  try {
                    for (
                      var _iterator9 = Array.from(record.addedNodes)[
                          Symbol.iterator
                        ](),
                        _step9;
                      ...
                      try {
                        for (
                          var _iterator10 = inertElements[Symbol.iterator](),
                            _step10;
